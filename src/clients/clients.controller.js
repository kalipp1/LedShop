...
var ClientsController = function () {
    ...
    var ClientsController = _classThis = /** @class */ (function () {
        ...
        ClientsController_1.prototype.getAll = function () {
            return this.clientsService.getAll();
        };
        ClientsController_1.prototype.getById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var client;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.clientsService.getById(id)];
                        case 1:
                            client = _a.sent();
                            if (!client)
                                throw new common_2.NotFoundException('Client not found');
                            return [2 /*return*/, client];
                    }
                });
            });
        };
        ClientsController_1.prototype.deleteById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.clientsService.getById(id)];
                        case 1:
                            if (!(_a.sent()))
                                throw new common_2.NotFoundException('Client not found');
                            return [4 /*yield*/, this.clientsService.deleteById(id)];
                        case 2:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            if (!(_a.sent()))
                                throw new common_2.NotFoundException('Client not found');
                            return [4 /*yield*/, this.clientsService.updateById(id, clientData)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, { success: true }];
                    }
    ...
    (function () {
        ...
        _getAll_decorators = [(0, common_1.Get)('/'), (0, common_1.UseGuards)(admin_guard_1.AdminGuard)];
        _getById_decorators = [(0, common_1.Get)('/:id'), (0, common_1.UseGuards)(admin_guard_1.AdminGuard)];
