...
var ClientsService = function () {
    ...
    var ClientsService = _classThis = /** @class */ (function () {
        function ClientsService_1(prismaService) {
            this.prismaService = prismaService;
        }
        ClientsService_1.prototype.getAll = function () {
            return this.prismaService.client.findMany();
        };
        ClientsService_1.prototype.getById = function (id) {
            return this.prismaService.client.findUnique({
                where: { id: id },
                include: { orders: true }
            });
        };
        ClientsService_1.prototype.deleteById = function (id) {
        ...
        ClientsService_1.prototype.updateById = function (id, clientData) {
