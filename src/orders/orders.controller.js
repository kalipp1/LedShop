            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            return [2 /*return*/, { message: 'Order canceled successfully' }];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.ordersService.create(orderData)];
                        case 1:
                            order = _a.sent();
                            return [2 /*return*/, {
                        ...
                        case 2:
                            ...
                            throw new common_1.HttpException('Error creating order', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
