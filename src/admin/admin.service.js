...
var AdminService = function () {
    ...
    var AdminService = _classThis = /** @class */ (function () {
        ...
        AdminService_1.prototype.login = function (login, password) {
            return __awaiter(this, void 0, void 0, function () {
                var admin, isValid, secretKey, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.admin.findUnique({ where: { login: login } })];
                        case 1:
                            admin = _a.sent();
                            if (!admin) {
                        ...
                        case 2:
                            ...
                            token = jwt.sign({ id: admin.id, login: admin.login }, secretKey, { expiresIn: "1h" });
        ...
        AdminService_1.prototype.logout = function (token) {
            console.log("Unieważniam token:", token);
            this.revokedTokens.add(token);
            return { message: "Logged out successfully" };
        };
        AdminService_1.prototype.isTokenValid = function (token) {
