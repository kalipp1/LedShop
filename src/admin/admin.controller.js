...
var AdminController = function () {
    ...
    var AdminController = _classThis = /** @class */ (function () {
        ...
        AdminController_1.prototype.login = function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                var login = _b.login, password = _b.password;
                return __generator(this, function (_c) {
                    return [2 /*return*/, this.adminService.login(login, password)];
                });
            });
        };
        AdminController_1.prototype.logout = function (req) {
            var _a;
    ...
    (function () {
        ...
        _logout_decorators = [(0, common_1.Post)("logout"), (0, common_1.UseGuards)(admin_guard_1.AdminGuard)];
